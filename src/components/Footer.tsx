      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-luxury-cream/10 pb-12 mb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-[11px] text-luxury-cream/60">100% Handcrafted Certified Mulberry Silk</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-[11px] text-luxury-cream/60">Complimentary Shipping Over ₹10,000</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-[11px] text-luxury-cream/60">Complimentary Tailoring & Size Exchange</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs uppercase tracking-widest text-luxury-cream/70">
              ...
              <li><Link href="/shop" className="hover:text-luxury-gold transition-colors">Bespoke Fit Guide</Link></li>
          ...
          {/* Couture Collections Links */}
          <div className="space-y-3">
            <h4 className="font-serif text-xs font-bold uppercase tracking-[0.25em] text-luxury-gold">
              COUTURE
            </h4>
            <ul className="space-y-2 text-xs uppercase tracking-widest text-luxury-cream/70">
              <li><Link href="/category/dresses" className="hover:text-luxury-gold transition-colors">Evening Gowns</Link></li>
              <li><Link href="/category/sarees" className="hover:text-luxury-gold transition-colors">Kanjeevaram Sarees</Link></li>
              <li><Link href="/collection/silk-symphony" className="hover:text-luxury-gold transition-colors">Silk Symphony</Link></li>
              <li><Link href="/collection/royal-velvet" className="hover:text-luxury-gold transition-colors">Royal Velvet</Link></li>
            </ul>
          </div>
