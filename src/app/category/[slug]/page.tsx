  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white text-charcoal">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white border border-border p-8 rounded-2xl text-charcoal shadow-subtle">
          <p className="font-serif text-xl font-normal text-charcoal mb-2">No drops currently available in {categoryName}</p>
          <Link href="/shop" className="font-mono text-xs uppercase tracking-widest text-royal font-bold hover:underline transition-colors">
            Browse All Drops →
          </Link>
        </div>
      ) : (
