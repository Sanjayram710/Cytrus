          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                Most t-shirts lose their structure after three washes. At LUXEWEAR, every garment is constructed with high-density 280-300 GSM French Terry organic cotton and double-needle reinforced necklines.
              </p>
              <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
